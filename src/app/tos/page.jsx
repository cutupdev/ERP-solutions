...
const page = () => {
    return (
        <Fragment>
            ...
            <div
                id="termsmain"
                className="text-left  md:px-52 px-20 md:py-0 py-10 my-10"
            >
                <h1 className="text-5xl text-gray-900 font-bold my-10">
                    Welcome to Wahni IT Solutions!
                </h1>
                <p className="my-2 text-base text-gray-800">
                    These terms and conditions outline the rules and regulations
                    for the use of Wahni IT Solutions Pvt Ltd&lsquo;s Website,
                    located at wahni.io.
                </p>
                <p className="my-2 text-base text-gray-800">
                    By accessing this website we assume you accept these terms
                    and conditions. Do not continue to use Wahni IT Solutions if
                ...
                <p className="my-2 text-base text-gray-800">
                    ...
                    Agreements: &lsquo;Client&lsquo;, &lsquo;You&lsquo; and
                    &lsquo;Your&lsquo; refers to you, the person log on this
                    website and compliant to the Company&lsquo;s terms and
                    conditions. &lsquo;The Company&lsquo;,
                    &lsquo;Ourselves&lsquo;, &lsquo;We&lsquo;, &lsquo;Our&lsquo;
                    and &lsquo;Us&lsquo;, refers to our Company.
                    &lsquo;Party&lsquo;, &lsquo;Parties&lsquo;, or
                    &lsquo;Us&lsquo;, refers to both the Client and ourselves.
                    ...
                    the express purpose of meeting the Client&lsquo;s needs in
                    respect of provision of the Company&lsquo;s stated services,
                    in accordance with and subject to, prevailing law of in. Any
                ...
                <h2 className="font-semibold text-3xl text-gray-800 my-4">
                    Cookies
                </h2>
                <p className="my-2 text-base text-gray-800">
                    We employ the use of cookies. By accessing Wahni IT
                    Solutions, you agreed to use cookies in agreement with the
                    Wahni IT Solutions Pvt Ltd&lsquo;s Privacy Policy.
                </p>
                <p className="my-2 text-base text-gray-800">
                    Most interactive websites use cookies to let us retrieve the
                    user&lsquo;s details for each visit. Cookies are used by our
                ...
                <p className="my-2 text-base text-gray-800">
                    Unless otherwise stated, Wahni IT Solutions Pvt Ltd and/or
                    its licensors own the intellectual property rights for all
                    material on Wahni IT Solutions. All intellectual property
                    rights are reserved. You may access this from Wahni IT
                    Solutions for your own personal use subjected to
                    restrictions set in these terms and conditions.
                </p>
                <p className="my-2 text-base text-gray-800">You must not:</p>
                <ul className="list-disc text-gray-800 list-inside px-5 py-3">
                    <li> Republish material from Wahni IT Solutions</li>
                    <li>
                        {' '}
                        Sell, rent or sub-license material from Wahni IT
                        Solutions
                    </li>
                    <li>
                        Reproduce, duplicate or copy material from Wahni IT
                        Solutions
                    </li>
                    <li> Redistribute content from Wahni IT Solutions</li>
                </ul>
                <p className="my-2 text-base text-gray-800">
                    Parts of this website offer an opportunity for users to post
                    and exchange opinions and information in certain areas of
                    the website. Wahni IT Solutions Pvt Ltd does not filter,
                    edit, publish or review Comments prior to their presence on
                    the website. Comments do not reflect the views and opinions
                    of Wahni IT Solutions Pvt Ltd,its agents and/or affiliates.
                    Comments reflect the views and opinions of the person who
                    post their views and opinions. To the extent permitted by
                    applicable laws, Wahni IT Solutions Pvt Ltd shall not be
                ...
                <p className="my-2 text-base text-gray-800">
                    Wahni IT Solutions Pvt Ltd reserves the right to monitor all
                ...
                <p className="my-2 text-base text-gray-800">
                    You hereby grant Wahni IT Solutions Pvt Ltd a non-exclusive
                ...
                <ul className="list-disc text-gray-800 list-inside px-5 py-3">
                    ...
                    <li>
                        fits within the context of the linking party&lsquo;s
                        site.
                    </li>
                </ul>
                <p className="my-2 text-base text-gray-800">
                ...
                <ul className="list-disc text-gray-800 list-inside px-5 py-3">
                    ...
                    <li>Frappe.io and its parent or child organizations;</li>
                ...
                <ul className="list-disc text-gray-800 list-inside px-5 py-3">
                    <li>
                        the link would not make us look unfavorably to ourselves
                    ...
                    <li>
                        ...
                        compensates the absence of Wahni IT Solutions Pvt Ltd;
                        and{' '}
                    </li>
                    <li>
                ...
                <p className="my-2 text-base text-gray-800">
                    ...
                    inform us by sending an e-mail to Wahni IT Solutions Pvt
                ...
                <ul className="list-disc text-gray-800 list-inside px-5 py-3">
                    ...
                    <li>
                        ...
                        of content on the linking party&lsquo;s site.
                    </li>
                </ul>
                <p className="my-2 text-base text-gray-800">
                    No use of Wahni IT Solutions Pvt Ltd&lsquo;s logo or other
                ...
                <h1 className="font-semibold text-3xl text-gray-800 my-4">
                    Content Liability
                </h1>
                ...
                <p className="my-2 text-base text-gray-800">
                    ...
                    and it&lsquo;s linking policy at any time. By continuously
                    linking to our Website, you agree to be bound to and follow
                    these linking terms and conditions. Removal of links from
                    our website
                </p>
                <p className="my-2 text-base text-gray-800">
